<?php
include_once get_template_directory() . '/config/menus.php';

include_once get_template_directory() . '/config/theme.php';

include_once get_template_directory() . '/config/enqueuer.php';

include_once get_template_directory() . '/config/acf.php';
