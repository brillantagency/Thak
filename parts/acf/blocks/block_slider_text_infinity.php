...
?>
<div class="block_text_infinity padding_<?php echo $slider_text_infinity_padding; ?>">
    <div class="text_infinity text_infinity-js text_infinity_bg_<?php echo $slider_text_infinity_bg_color; ?>">
        <?php for($i = 0; $i <= 1; $i++) : ?>
